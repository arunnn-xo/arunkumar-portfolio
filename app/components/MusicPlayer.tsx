...
export default function MusicPlayer({ autoplayEnabled = true, className = "fixed bottom-6 right-6 z-50" }: MusicPlayerProps) {
    ...
    const attemptPlayback = useCallback((forceMuted?: boolean) => {
        const audio = audioRef.current;
        if (!audio) return Promise.reject(new Error("Audio not ready"));

        const nextMuted = forceMuted ?? isMuted;
    ...
    useEffect(() => {
        ...
        const addInteractionListeners = () => {
            ...
            document.addEventListener("click", startPlayback, { capture: true });
            document.addEventListener("touchstart", startPlayback, { capture: true });
            document.addEventListener("keydown", startPlayback, { capture: true });
        };
    ...
    }, [attemptPlayback, autoplayEnabled]);
    ...
    useEffect(() => {
        ...
        document.addEventListener("touchstart", unlockSound, { capture: true });
    ...
    return (
        <>
            <audio ref={audioRef} src={SONG_SRC} preload="auto" loop autoPlay playsInline />
                ...
                <AnimatePresence mode="wait">
                    {isExpanded ? (
                        <motion.div
                            ...
                            style={{
                                background:
                                    "linear-gradient(135deg, rgba(15,12,41,0.95), rgba(48,43,99,0.9), rgba(36,36,62,0.95))",
                                backdropFilter: "blur(24px)",
                                border: "1px solid rgba(99,102,241,0.2)",
                                boxShadow:
                                    "0 25px 60px -12px rgba(79,70,229,0.4), 0 0 40px rgba(99,102,241,0.15), inset 0 1px 0 rgba(255,255,255,0.05)",
                            }}
                        >
                            ...
                            <div className="flex justify-center py-6">
                                <div className="relative">
                                    <div
                                        ...
                                        style={{
                                            background:
                                                "conic-gradient(from 0deg, rgba(99,102,241,0.3), rgba(6,182,212,0.3), rgba(168,85,247,0.3), rgba(99,102,241,0.3))",
                                            filter: "blur(20px)",
                      ...
                      `,
                            ...
                            <div className="flex items-center justify-center gap-5 px-6 pb-6 pt-2">
                                <button
                                    ...
                                    className="p-2 text-gray-400 hover:text-white transition-colors hover:scale-110 active:scale-95"
                                >
                                    <SkipBack size={20} />
                                </button>
